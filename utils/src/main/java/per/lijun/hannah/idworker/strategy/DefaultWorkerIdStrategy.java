package per.lijun.hannah.idworker.strategy;

import per.lijun.hannah.idworker.WorkerIdStrategy;
import per.lijun.hannah.idworker.utils.HttpReq;
import per.lijun.hannah.idworker.utils.Ip;
import per.lijun.hannah.idworker.utils.Props;
import per.lijun.hannah.idworker.utils.Utils;
...
public class DefaultWorkerIdStrategy implements WorkerIdStrategy {
    ...
    private final Properties props =
            Props.tryProperties("per.lijun.hannah.idworker-client.properties", Utils.DOT_IDWORKERS);
