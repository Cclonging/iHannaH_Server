...
public class FileUtils {
	...
	public static String uploadRes(String localPath, String resource, FastDFSClient fastDFSClient) throws Exception {
		FileUtils.base64ToFile(localPath, resource);
		MultipartFile face = FileUtils.fileToMultipart(localPath);

		return fastDFSClient.uploadSound(face);
	}
